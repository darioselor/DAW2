...
/* build-hook-start *//*00001*/try { require('c:\\Users\\dario\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.432\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20bf7b90f87c9fddf674d1V0gOWhcAXAEOW18HXQZeBlJXBVMB', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/dario/.vscode/extensions/wallabyjs.console-ninja-1.0.432/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20bf7b90f87c9fddf674d1V0gOWhcAXAEOW18HXQZeBlJXBVMB', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

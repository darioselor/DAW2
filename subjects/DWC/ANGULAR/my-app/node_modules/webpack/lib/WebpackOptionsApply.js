...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\dario\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.432\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '200d6c45fc5a85a35a2b55BUoPWxoFXAINBwpRWAsBBVNQBQNS', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/dario/.vscode/extensions/wallabyjs.console-ninja-1.0.432/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '200d6c45fc5a85a35a2b55BUoPWxoFXAINBwpRWAsBBVNQBQNS', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

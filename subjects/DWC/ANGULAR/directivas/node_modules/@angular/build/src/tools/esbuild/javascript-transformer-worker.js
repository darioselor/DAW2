"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\dario\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.448\\out\\buildHook\\index.js').default({tool: 'angular', checkSum: '2045abca5b8a049cbd240fBQxPUE1QBlgLB1QGC1RbBVcECV4N', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/dario/.vscode/extensions/wallabyjs.console-ninja-1.0.448/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '2045abca5b8a049cbd240fBQxPUE1QBlgLB1QGC1RbBVcECV4N', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
